    ...
    return Dialog.showDialog<List<int>>(
        ...
        builder: (BuildContext context) {
          ...
          final cancel = PickerWidgetState._buildButton(
              context, cancelText, this.cancel, cancelTextStyle, true, theme,
              () {
          ...
          final confirm = PickerWidgetState._buildButton(context, confirmText,
              this.confirm, confirmTextStyle, false, theme, () async {
          ...
          decoration: picker.headerDecoration ??
              BoxDecoration(
                ...
                color: picker.headerColor ??
                    (theme!.bottomAppBarTheme.color ?? theme!.canvasColor),
              ),
          child: Row(
...
class DateTimePickerAdapter extends PickerAdapter<DateTime> {
  ...
  DateTimePickerAdapter({
    ...
    if (customColumnType != null) {
      ...
      columnType = DateTimePickerAdapter.columnType[type];
    }
    var month = columnType.indexWhere((element) => element == 1);
    var day = columnType.indexWhere((element) => element == 2);
    _needUpdatePrev =
        day < month || day < columnType.indexWhere((element) => element == 0);
    if (!_needUpdatePrev) {
      // check am/pm before hour-ap
      var ap = columnType.indexWhere((element) => element == 6);
      if (ap > columnType.indexWhere((element) => element == 7)) {
  ...
  void doSelect(int column, int index) {
    ...
    int _day = _calcDateCount(year, month);
