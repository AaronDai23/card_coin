...
class UnlockCardRunnable extends BaseRunnable {
  late List<int> pukCode;
  late List<int> pinCode;
  UnlockCardRunnable({required this.pukCode, required this.pinCode});
  ...
  @override
  Uint8List getHeader() {
    return Uint8List.fromList([0x80, 0x52, 0x00, 0x00]);
  }
