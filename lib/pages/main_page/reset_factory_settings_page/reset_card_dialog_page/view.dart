...
import 'package:card_coin/pages/main_page/reset_factory_settings_page/reset_card_dialog_page/action.dart';
...
Widget buildView(
    ResetCardDialogState state, Dispatch dispatch, ViewService viewService) {
                ...
                child: Column(
                  children: [
                    ...
                    CCButton(
                      ...
                      onPressed: () => dispatch(
                          ResetCardDialogActionCreator.onPwdBtnClick()),
                    )
                  ],
                ),
              )
