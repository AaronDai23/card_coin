...
Widget buildView(
    ScanWalletState state, Dispatch dispatch, ViewService viewService) {
  ...
  return Scaffold(
      ...
      body: PageDataLoadingView(
        ...
        onReload: () {
          ...
          dispatch(ScanWalletActionCreator.onLoadDefaultCurrency());
        },
        onLoadSuccess: () {
          return Material(
            child: Stack(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ElevatedButton(
                          onPressed: () {
                            dispatch(ScanWalletActionCreator.onScanCard());
                          },
