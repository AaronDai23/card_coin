...
Widget buildView(
    AllActivateState state, Dispatch dispatch, ViewService viewService) {
  ...
  return Scaffold(
    appBar: AppBar(
      ...
      title: Text(languageResource.allActivate),
    ),
            ...
            children: [
              ...
              Expanded(
                ...
                child: Center(
                  ...
                  onPressed: () =>
                      dispatch(AllActivateActionCreator.onActivateClick()),
